        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 footer-marg">
            <div class="footer-widget">
              <h3>ABOUT US</h3>
              <p>Cras ac tempus ipsum etiam eu libero suscipit. Zolutpat ante a malesuada nunc, junc sit amet elementum
                est semper leo vel ante vestibulum </p>
              <div class="social">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="copyright">
              <p>Copyright © <a href="http://www.bootstrapmb.com/">Richman</a>. All Rights Reserved</p>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
